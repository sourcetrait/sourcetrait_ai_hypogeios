...
# behavior source-of-truth; this is durable hypogeios build tooling - re-run it
# whenever ~/repo/github/jclaar/zork changes. Emits rooms.json + objects.json to <out> and
...
def emit_syntax(actions, verb_words, path):
    ...
    open(path, 'w').write(
        '# Generated by tools/port_zork.py from ~/repo/github/jclaar/zork - do not edit by hand.\n'
...
def emit_nu(rows, name, path):
    ...
    open(path, 'w').write(
        f'# Generated by tools/port_zork.py from ~/repo/github/jclaar/zork - do not edit by hand.\n'
