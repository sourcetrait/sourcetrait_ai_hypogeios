...
This repository provides multiple Nu [libraries](./libraries).  
Each library is conveyed under the terms of its own license.

Anything outside of individual libraries - the repository itself - is conveyed
under the terms of the [AGPL 3](./LICENSE-AGPL-3.txt) license.

This software is designed to be ran within a *SourceTrait Empower* container.
...
Repository License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait AI Hypogeios: Classic terminal games preserved a Nu
